"""
# build_database.py
    - A helper Python script to rebuild the people.db database
    - Running `python build_database.py` from the command line will re-create
    the database with the new additions, getting it ready for use with the web.

    `Note` Executing build_database.py, recreates people.db. Any existing data
    in people.db will be lost.
"""
